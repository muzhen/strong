...
var swipeRecognizer = {
    events: ['swiper', 'swipeleft', 'swiperight', 'swipeup', 'swipedown'],
    ...
    touchend: function (event) {
        ...
        Recognizer.end(event, function (pointer, touch) {
            ...
            if (isflick) {
                ...
                Recognizer.fire(target, 'swiper', extra)
                Recognizer.fire(target, 'swiper' + extra.direction, extra)
            }
        })
    }
}
...
Recognizer.add('swiper', swipeRecognizer)
