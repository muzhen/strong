    ...
    <h1>闽侯县水利局 <span class="pull-right ">{{showTime}}</span></h1>
    ...
    <div class="col-sm-6 right-part"  >
        <div class=" content  ">
          <div class=" rain-chart" >
                <!-- <img src="../av-modules/fourWin/static/img/sea.jpg" alt=""/>-->
               <img ms-attr-src="http://192.168.110.233:9995/web/{{rainChart}}"  alt=""/> 
