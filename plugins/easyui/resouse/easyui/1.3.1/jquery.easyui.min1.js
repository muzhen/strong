...
(function ($) {
    ...
    function _305(_306, _307, _308) {
        ...
        function _30d() {
            ...
            if (_307 == "east") {
                return {
                    resizeC: {width: _309.center.panel("options").width + _309["east"].panel("options").width - 28},
                    expand: {left: cc.width() - _309["east"].panel("options").width},
                    expandP: {
                ...
                if (_307 == "west") {
                    return {
                        ...
                        collapse: {left: -_309["west"].panel("options").width}
                    };
                } else {
                    if (_307 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_309["north"].panel("options").height}
                        };
                    } else {
                        if (_307 == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _309["south"].panel("options").height},
                ...
                if (_311 == "west" && _312.expandWest) {
                    ...
                    if (_311 == "north" && _312.expandNorth) {
                        ...
                        if (_311 == "south" && _312.expandSouth) {
                            return {
                                collapse: {top: cc.height()},
                                expand: {top: cc.height() - _312["south"].panel("options").height}
                            };
                        }
                    }
                }
